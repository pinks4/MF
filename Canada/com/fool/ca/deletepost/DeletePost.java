package com.fool.ca.deletepost;
...
/*
        ...
        */
        ...
        if (ele.size() > 0) {
          ...
          //  Thread.sleep(2000);
            ...
            if (s.equalsIgnoreCase("1 post moved to the Trash. Undo")) {         
            	Reporter.log("Motely Fool Canada Article is Deleted successfully");
            }        
        ...
        if (ele2.size() > 0 || ele1.size() > 0) {
            ...
            Reporter.log("Motely Fool Canada Article Deletion Verified successfully");
        }
