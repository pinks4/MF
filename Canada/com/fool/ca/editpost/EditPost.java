    ...
    public void editingCreatedPost() throws Throwable {
       ...
       // Thread.sleep(3000);
        ...
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(read.getObject("Link_Img2Canada"))));
            super.clickButton(read.getObject("Link_Img2Canada"));
        } catch (Throwable e1) {
            // TODO Auto-generated catch block
            e1.printStackTrace();
            Assert.assertFalse(true);
      ...
      //  Thread.sleep(2000);
        try {
            ...
            if (s.equalsIgnoreCase("Post updated. View post")) {         
            	Reporter.log("Motely Fool Canada Article is Edited successfully");
            }
            try {
                super.getUrl(read.readData("Browser&URL", 3, 2));
            } catch (Throwable e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
                Assert.assertFalse(true);
            ...
            if (isPresent.equals(true)) {
                ...
                Reporter.log("Motely Fool Canada Article Edit Verified successfully");
                driver.quit();
            } else {
