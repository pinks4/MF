...
public class EVLFilterchrome extends PageObjectModule {
    ...
    public void AssetClassfilter() throws Throwable {
    	...
    	Iterator<WebElement> i2=linkslc.iterator();
    	   while(i2.hasNext()){    	 
    	...
    	Iterator<WebElement> i3=linksin.iterator();
    	   while(i3.hasNext()){    	 
	...
	Iterator<WebElement> i4=linksli.iterator();
	   while(i4.hasNext()){    	 
	...
	Iterator<WebElement> i5=linkssli.iterator();
	   while(i5.hasNext()){    	 
	...
	Iterator<WebElement> i6=linkssi.iterator();
	   while(i6.hasNext()){    	 
	...
	Iterator<WebElement> i7=linkssl.iterator();
	   while(i7.hasNext()){    	 
